        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            legalSection(number: "1", title: "Definitions") {
                paragraphs([
                    ...
                    "\"Subscription\" means a paid recurring entitlement to premium features within the Application, currently offered through the Coach plan described in Section 6.",
            ...
            legalSection(number: "6", title: "Subscriptions, Billing, and In-App Purchases") {
                paragraphs([
                    "6.1 Subscription Offering. The Application currently offers an optional paid Coach Subscription that provides access to premium features beyond those available in the free tier. The Company may add, remove, rename, or discontinue Subscription offerings in the future at its discretion.",
