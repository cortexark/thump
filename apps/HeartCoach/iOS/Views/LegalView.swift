...
struct TermsOfServiceContent: View {
    ...
    private let effectiveDate = "March 11, 2026"
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            legalSection(number: "12", title: "Termination") {
                paragraphs([
                    "12.1 Termination by Company. The Company may, in its sole discretion, at any time and without prior notice or liability, terminate or suspend your access to or use of the Application, or any portion thereof, for any reason or no reason, including if the Company reasonably believes you have violated any provision of this Agreement.",
                    "12.2 Effect of Termination. Upon any termination of this Agreement or your access to the Application: (a) all licenses and rights granted to you hereunder shall immediately cease; (b) you must cease all use of the Application and delete all copies from your devices; and (c) you shall have no right to any refund of prepaid Subscription fees, except as required by Apple's App Store policy or applicable law.",
                    "12.3 Survival. The following provisions shall survive termination of this Agreement: Sections 1 (Definitions), 3 (Medical Disclaimer), 4 (Disclaimer of Warranties), 5 (Limitation of Liability), 7.3-7.4 (Intellectual Property), 10 (Indemnification), 11 (Governing Law; Arbitration; Class Action Waiver), and 13 (Miscellaneous)."
                ])
            }
        ...
        VStack(alignment: .leading, spacing: 24) {
            ...
            legalSection(number: "2", title: "Categories of Information We Collect") {
                ...
                paragraphs([
                    ...
                    "ALL HEALTH AND BIOMETRIC DATA IS PROCESSED EXCLUSIVELY ON YOUR DEVICE. Health Data read from HealthKit is never transmitted to, stored on, or accessible by any server, system, or infrastructure operated or controlled by the Company. The Company does not have remote access to your Health Data.",
                    "The Application does not write any data to Apple HealthKit."
                ])

                legalSubheading("2.2 Usage Analytics and Telemetry Data")
                paragraphs([
                    "To evaluate Application performance and improve the accuracy of our wellness algorithms, we may collect and transmit anonymized, aggregated usage and telemetry data. This data is stripped of any information that could identify you as a natural person before transmission and includes:",
                    "• Feature interaction events (e.g., which application screens are accessed, which features are invoked, frequency of use patterns) — collected anonymously without association to any personal identifier\n• Performance diagnostics including crash logs, application hang reports, memory utilization metrics, and battery impact data, collected via Apple's MetricKit framework and transmitted through Apple's infrastructure\n• Application session frequency and duration in aggregated, anonymized form\n• Subscription tier status (i.e., Free, Pro, Coach, or Family) for the purpose of gating premium feature access and analyzing aggregate tier distributions",
                    "This telemetry data: (a) is anonymized prior to any transmission; (b) is processed in aggregate form only; (c) cannot be reasonably used to identify, contact, or locate any individual User; and (d) is never combined with personally identifiable information.",
                ...
                legalSubheading("2.3 User-Provided Profile Information")
                paragraphs([
                    "During initial onboarding, you may optionally enter a display name. This display name is stored exclusively in encrypted local storage on your device and is never transmitted to or retained by the Company. The Company has no access to and does not store your display name."
                ])
                ...
                paragraphs([
                    "For the purpose of diagnosing software defects and maintaining Application compatibility, the Application may record technical diagnostic identifiers in anonymized form, including: device hardware model designation, iOS and watchOS version numbers, and Application version and build numbers. This information is collected in aggregate form only and is not associated with any personal identifier."
                ])
            }
            ...
            legalSection(number: "4", title: "On-Device Processing; Data Storage; Security") {
                paragraphs([
                    "4.1 Exclusive On-Device Processing. All Health Data is processed on-device by the Application. The Company does not operate cloud infrastructure for the storage or processing of User Health Data. No Health Data is transmitted off your device.",
                    ...
                    "4.4 No Cloud Sync. The Company does not operate cloud backup or synchronization services for Health Data. The Application does not store Health Data in iCloud, third-party cloud storage, or any other remote storage system controlled by the Company.",
                    ...
                    "4.6 Data Deletion upon Uninstallation. Deleting the Application from your device will remove all locally stored Application data from that device. This action is irreversible. The Company has no ability to recover deleted on-device data on your behalf."
                ])
            }
            ...
            legalSection(number: "7", title: "Your Rights and Controls") {
                ...
                legalSubheading("7.3 Data Deletion")
                paragraphs([
                    "You may delete all locally stored Application data at any time by uninstalling the Application from your device. Uninstallation permanently and irreversibly removes all Application-generated data from that device. The Company has no mechanism to recover this data for you after deletion."
                ])
            ...
            legalSection(number: "11", title: "Health Data — Special Category Notice") {
                ...
                paragraphs([
                    "The Company does not use Health Data to make automated decisions that produce legal or similarly significant effects on you. The Company does not use Health Data to infer other sensitive categories of information (e.g., race, ethnicity, religion, sexual orientation, or immigration status)."
                ])
            }
